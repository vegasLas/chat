const { UserInputError, ForbiddenError, AuthenticationError, withFilter } = require('apollo-server')
    ...
    Mutation: {
        ...
        reactToMessage: async (_, { uuid, content }, { user, pubsub }) => {
            ...
            try {
                ...
                if (message.from !== user.username && message.to !== user.username) { throw new ForbiddenError('Unautorized') }
